    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100">
      ...
      <header className="bg-white/80 backdrop-blur-sm border-b sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-green-800">NutriCoach</span>
          </div>
          <div className="flex items-center gap-2">
            <Button
              variant="outline"
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <footer className="mt-12 text-center text-gray-500 text-sm">
          <p>
            {language === 'es'
              ? 'Este plan fue generado por NutriCoach. La información nutricional es aproximada.'
              : 'This plan was generated by NutriCoach. Nutritional information is approximate.'}
          </p>
          <p className="mt-2">
